...
let EntradaComponent = class EntradaComponent {
    ...
    start() {
        Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["interval"])(this.repeticiones).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeWhile"])(() => this.play)).subscribe(() => this.inicia());
    }
    inicia() {
        ...
        if (this.cuentaVueltas > this.repeticiones) {
            ...
            if (this.tiempo === 0) {
                Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["timer"])(this.tiempo, 1000).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(this.segundos)).subscribe(() => this.crono());
            }
